...
{"achromatic number", "bir çizgenin boyanması için gereken maksimum renk"},
{"adjacency matrix", "bitişiklik matrisi"},
{"articulation point", "boğumlanma noktası"},
{"cut point", "boğumlanma noktası"},
{"automorphism", "öseşyapı dönüşümü"},
{"weighted graph", "ağırlıklı çizge"},
{"vertex", "köşe"},
{"valency", "derece"},
{"universal approximation theorem", "evrensel yaklaşım (yakınsama) teoremi"},
{"pseudograph", "döngülere izin veren çizge"},
{"isomorphism", "eşbiçimlilik"},
{"in-degree", "yönlü bir çizgede bir köşeye gelen kenar sayısı"},
{"out degree","yönlü bir çizgede bir köşeden çıkan kenar sayısı"},
{"incidence matrix", "olasılık matrisi"},
{"functional graph", "fonksiyonel çizge"},
{"dipath", "yönlü yol"},
{"DAG", "directed acyclic graph"},
{"directed acyclic graph", "yönlü çevrimsiz çizge"},
{"edge cut", "(çizgede) köprü"},
{"direct successor", "(çizgede) kuyruğu verilen bir köşede olan yönlü kenar"},
{"direct predecessor", "(çizgede) başlangıcı verilen bir köşede olan yönlü kenar"},
